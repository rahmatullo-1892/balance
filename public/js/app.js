...
function sortCol() {
  ...
  rows.sort(function (a, b) {
    return asc ? new Date(b.cells[1].getAttribute("sort-val")) - new Date(a.cells[1].getAttribute("sort-val")) : new Date(a.cells[1].getAttribute("sort-val")) - new Date(b.cells[1].getAttribute("sort-val"));
  });
